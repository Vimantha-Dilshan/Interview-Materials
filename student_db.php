...
<body>
    ...
    <br>
    <center>
        <h1 class="log-head text-success">Student List</h1>
        <h9 class="sub-head text-primary">All students</h9>
        <br>
        <a href="student_reg.php"><button type="button" class="btn btn-outline-success btn-sm"><i class="bi bi-file-earmark-plus-fill"></i> Add new</button></a>
        <div class="container-fluid">
            <hr>
        </div>
    </center>
        ...
        <table class="table table-hover table-sm" id="myTable" name="myTable">
            <thead class="table-success">
                <tr>
                    ...
                    <th class="tblhead" scope="col">OOP</th>
                    <th class="tblhead" scope="col">OOP Marks</th>
                    <th class="tblhead" scope="col">WAD</th>
                    <th class="tblhead" scope="col">WAD Marks</th>
                    <th class="tblhead" scope="col">IDCP</th>
                    <th class="tblhead" scope="col">IDCP Marks</th>
                </tr>
            </thead>
            <tbody>
            <?php
                ...
                $sql = "SELECT `index`, `name`, `address`, `birthday`, `oop`, `oopmarks`, `wad`, `wadmarks`, `idcp`, `idcpmarks` from `students`";
                ...
                if ($result->num_rows > 0) {
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo 
                            "<tr><td><a href='$view'><button type='button' class='btn btn-outline-primary btn-sm'><i class='bi bi-person'></i> Profile</button></a>" .
                            "</td><td>" . $row["index"] . 
                            "</td><td>" . $row["name"] . 
                            "</td><td>" . $row["address"] . 
                            "</td><td>" . $row["birthday"] . 
                            "</td><td><span class='badge $oopvar text-uppercase'>" . $row["oop"] . 
                            "</span></td><td>" . $row["oopmarks"] . 
                            "</td><td><span class='badge $wadvar text-uppercase'>" . $row["wad"] . 
                            "</span></td><td>" . $row["wadmarks"] . 
                            "</td><td><span class='badge $idcpvar text-uppercase'>" . $row["idcp"] .
