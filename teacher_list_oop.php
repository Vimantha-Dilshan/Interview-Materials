...
<body>
    ...
    <br>
    <center>
        <h1 class="log-head text-danger">Object-Oriented Programming</h1>
        ...
        <table class="table table-hover table-sm" id="myTable">
            <thead class="table-primary">
                <tr>
                    ...
                    <th class="tblhead2" scope="col">OOP Status</th>
            ...
            <?php
                ...
                $sql = "SELECT `index`, `name`, `oop`, `oopmarks`, `wad`, `wadmarks`, `idcp`, `idcpmarks` from `students` where `oop` = 'Participated'";
