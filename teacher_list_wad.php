...
<body>
    ...
    <br>
    <center>
        <h1 class="log-head text-danger">Web Application Development</h1>
        ...
        <table class="table table-hover table-sm" id="myTable">
            <thead class="table-primary">
                <tr>
                    ...
                    <th class="tblhead2" scope="col">WAD Status</th>
            ...
            <?php
                ...
                $sql = "SELECT `index`, `name`, `oop`, `oopmarks`, `wad`, `wadmarks`, `idcp`, `idcpmarks` from `students` where `wad` = 'Participated'";
