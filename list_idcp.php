...
<body>
    ...
    <br>
    <center>
        <h1 class="log-head text-success">Interactive Design Concepts and Practices</h1>
        ...
        <table class="table table-hover table-sm" id="myTable">
            <thead class="table-success">
                <tr>
                    ...
                    <th class="tblhead" scope="col">IDCP Status</th>
            ...
            <?php
                ...
                $sql = "SELECT `index`, `name`, `address`, `birthday`, `oop`, `oopmarks`, `wad`, `wadmarks`, `idcp`, `idcpmarks` from `students` where `idcp` = 'Participated'";
