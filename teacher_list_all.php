...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand text-danger" href="teacher_portal_home.php"><i class="bi bi-cone-striped"></i> Admin Portal</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="teacher_portal_home.php"><i class="bi bi-house-fill"></i> Home</a>
                    </li>
    ...
    <br>
    <center>
        <h1 class="log-head text-danger">All Subjects</h1>
    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" onkeyup="myFunction()" id="myInput" name="myInput" placeholder="Search by name...">
                        </div>
                    </div>
                    <div class="col">
        ...
        <!--Table-->
        <table class="table table-hover table-sm" id="myTable" name="myTable">
            <thead class="table-primary">
                <tr>
                    <th class="tblhead2" scope="col">Index</th>
                    <th class="tblhead2" scope="col">Name</th>
                    <th class="tblhead2" scope="col">OOP</th>
                    <th class="tblhead2" scope="col">OOP Marks</th>
                    <th class="tblhead2" scope="col">WAD</th>
                    <th class="tblhead2" scope="col">WAD Marks</th>
                    <th class="tblhead2" scope="col">IDCP</th>
                    <th class="tblhead2" scope="col">IDCP Marks</th>
                </tr>
            </thead>
            <tbody>
            <?php
                ...
                $sql = "SELECT * FROM `students` WHERE `oop` LIKE 'Participated' OR `wad` LIKE 'Participated' OR `idcp` LIKE 'Participated' ORDER BY `index` ASC";
                ...
                if ($result->num_rows > 0) {
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $view = "student_view.php?id=".$row["index"];
                            //This variable is save the details of user that need to show (GET Method)

                            echo 
                            "<tr><td>" . $row["index"] . 
                            "</td><td>" . $row["name"] . 
                            "</td><td><span class='badge $oopvar text-uppercase'>" . $oopval . 
                            "</span></td><td>" . $row["oopmarks"] . 
                            "</td><td><span class='badge $wadvar text-uppercase'>" . $wadval . 
                            "</span></td><td>" . $row["wadmarks"] . 
                            "</td><td><span class='badge $idcpvar text-uppercase'>" . $idcpval .
                            "</span></td><td>" . $row["idcpmarks"] .
                            "</td></tr>";
                        }
                    }
